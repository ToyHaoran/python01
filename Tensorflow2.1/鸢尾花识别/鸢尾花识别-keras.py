from keras import optimizers, losses, models, layers, regularizers
from sklearn import datasets
import numpy as np
import tensorflow as tf
# 也可以用 tf.keras.xxx的形式
...
"""
model.fit(data, label, batch_size=32, epochs=500, validation_split=0.2, validation_freq=20)
